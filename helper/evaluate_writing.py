...
def main():
    ...
    parser.add_argument('--provider', choices=['ollama', 'codex-cli'])
    parser.add_argument('--model')
    parser.add_argument('--memoire-strategy', choices=['personal-brief', 'luna-literary'])
    parser.add_argument('--chronicle-strategy', choices=['anchored', 'compact', 'luna-literary'])
