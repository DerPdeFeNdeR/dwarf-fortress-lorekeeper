...
without leaving DF. Existing biography generation and history scans must not be
...
outputs. Both use the established historian persona and factual coverage checks.
...
- Combining every citizen biography would duplicate events and incorrectly include
